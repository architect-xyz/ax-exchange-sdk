...
`CLOSE_ONLY`, `INSUFFICIENT_MARGIN`, `MAX_OPEN_ORDERS_EXCEEDED`, `UNKNOWN_SYMBOL`, `EXCHANGE_CLOSED`, `INCORRECT_QUANTITY`, `INVALID_PRICE_INCREMENT`, `INCORRECT_ORDER_TYPE`, `PRICE_OUT_OF_BOUNDS`, `NO_LIQUIDITY`, `INSUFFICIENT_CREDIT_LIMIT`, `ORIGINAL_ORDER_TERMINATED`, `DUPLICATE_CLIENT_ORDER_ID`
